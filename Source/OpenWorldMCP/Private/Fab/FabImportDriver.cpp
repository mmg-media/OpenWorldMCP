...
DEFINE_LOG_CATEGORY_STATIC(LogOpenWorldFabImport, Log, All);
...
namespace
{
	...
	void FinishImport(const TSharedPtr<FFabImportProgress>& State)
	{
		...
		UE_LOG(LogOpenWorldFabImport, Log, TEXT("Fab import complete: %d asset(s) (of %d new file(s)), root '%s'"),
	...
	void ImportDirectSource(const TSharedPtr<FFabImportProgress>& State, const FString& SourceFile)
	{
		...
		State->Phase = FFabImportProgress::EPhase::Done;
		UE_LOG(LogOpenWorldFabImport, Log, TEXT("Imported public Fab source '%s' into '%s' (%d assets)"),
...
bool FOpenWorldFabImport::Start(const FString& AssetId, const FString& AssetName, bool bIsPlugin,
...
bool FOpenWorldFabImport::StartDirect(const FString& AssetId, const FString& AssetName, const FString& DownloadUrl,
...
TSharedPtr<FFabImportProgress> FOpenWorldFabImport::Get(const FString& AssetId)
{
