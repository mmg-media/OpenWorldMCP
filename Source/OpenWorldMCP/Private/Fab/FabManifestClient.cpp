...
bool FOpenWorldFabManifest::Fetch(const FString& BaseUrl, const FString& ArtifactId, const FString& AssetNamespace,
                             ...
                             double TimeoutSeconds, FFabDownloadInfo& OutInfo, int32& OutHttpCode, FString& OutError)
{
	...
	const FString Url = OpenWorldMCP::Fab::ArtifactManifestUrl(BaseUrl, ArtifactId);
